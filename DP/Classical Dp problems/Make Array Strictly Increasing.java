Q:- https://leetcode.com/problems/make-array-strictly-increasing/
*************************************************************************
  class Solution {
    Integer dp[][];
    int util(int  arr1[], List<Integer> arr2, int i, int j) { //j=>-1 means not replaces in previous iteration
        if(i==arr1.length) {
            return 0;
        }
    ...
    public int makeArrayIncreasing(int[] arr1, int[] arr2) {
         //removing duplicates from arr2 & sorting
